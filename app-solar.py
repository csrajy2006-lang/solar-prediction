...
st.title("🌞 Solar Power Prediction App (Full Model)")
...
avg_temp_day = st.number_input("Average Temperature (Day) °C", -10.0, 60.0)
avg_wind_direction_day = st.number_input("Average Wind Direction (Day) °", 0, 360)
